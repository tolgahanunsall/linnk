    ...
    <footer className="border-t bg-white">
      <div className="container py-12">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            <h4 className="mb-3 text-sm font-semibold text-gray-900">Solutions</h4>
            <ul className="space-y-2 text-sm text-gray-600">
              <li><Link to="/tools" className="hover:text-indigo-600">Document Translator</Link></li>
              <li><Link to="/tools" className="hover:text-indigo-600">Document Summarizer</Link></li>
              <li><Link to="/tools" className="hover:text-indigo-600">Video Summarizer</Link></li>
              <li><Link to="/tools" className="hover:text-indigo-600">Research Assistant</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-10 border-t pt-6 text-sm text-gray-500">© {new Date().getFullYear()} Linnk AI. All rights reserved.</div>
      </div>
    </footer>
  );
}
